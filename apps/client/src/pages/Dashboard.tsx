...
import { apiListWorkflows, apiSignout, apiTradingStatus, type TradingStatus, type Workflow } from '@/lib/http';
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    apiTradingStatus().then(setTradingStatus).catch(() => setError('Could not load trading status. Please try again.'));
  }, []);
